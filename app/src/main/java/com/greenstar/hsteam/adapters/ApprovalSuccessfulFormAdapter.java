...
public class ApprovalSuccessfulFormAdapter extends ArrayAdapter<ApprovalQTVForm> {
    private Activity mActivity;
    private List<ApprovalQTVForm> list = new ArrayList<>();
    AppDatabase db =null;
    public ApprovalSuccessfulFormAdapter(@NonNull Activity activity, List<ApprovalQTVForm> list) {
